...
MO(3)  ,_______,_______,                _______,_______,        KC_END, KC_LEFT,KC_DOWN,KC_RIGHT
),
/* RAISE
 * ,--------------------------------------------------------------------------.
 * | Z/H  |  !  |  "  |  #  |  $  |  %  |  &  |  '  |  (  |  )  |  0  |       |
 ...
 */
[3] = LAYOUT_arrow(
_______,TO(1),  TO(2),  _______,_______,_______,_______,_______,_______,_______,_______,RESET,
